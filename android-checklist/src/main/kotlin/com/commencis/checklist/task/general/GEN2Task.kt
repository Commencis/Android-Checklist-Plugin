...
/**
 * Task that reminds to make sure that basic functionality of the app is fully working.
 */
open class GEN2Task : ChecklistTask() {
    override var taskCode: String = ChecklistData.CHECKLIST_TASK_GEN2
    override var taskDescription: String = "Make sure that basic functionality of the app is fully working."
