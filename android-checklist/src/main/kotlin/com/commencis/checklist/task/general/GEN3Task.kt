...
/**
 * Task that reminds to make sure that the app doesn't crash and works as expected
 */
open class GEN3Task : ChecklistTask() {
    override var taskCode: String = ChecklistData.CHECKLIST_TASK_GEN3
    override var taskDescription: String =
            "Make sure that the app doesn't crash and works as expected when the existing one is updated."
