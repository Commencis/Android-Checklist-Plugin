...
/**
 * Task that shows current version code to check whether it is incremented
 */
open class MAN1Task : ChecklistTask() {
    override var taskCode: String = ChecklistData.CHECKLIST_TASK_MAN1
    ...
    override var taskAction = {
        val versionCode = apkAnalyzerHelper.getVersionCode(project, apkPath, xmlParser)
        this.status = ChecklistTaskStatus.INFO
        val reportMessage = taskDescription + "Current Version Code: $versionCode"
