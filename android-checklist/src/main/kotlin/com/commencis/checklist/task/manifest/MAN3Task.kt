...
/**
 * Task that checks if the version name follows <major>.<minor>.<patch>.<buildNumber> convention.
 */
open class MAN3Task : ChecklistTask() {
    override var taskCode: String = ChecklistData.CHECKLIST_TASK_MAN3
    override var taskDescription =
            "Version names should follow &lt;major&gt;.&lt;minor&gt;.&lt;patch&gt;.&lt;buildNumber&gt; convention. "
    override var taskType: MutableList<ChecklistTaskType> = mutableListOf(ChecklistTaskType.APPLICATION)
    //TODO: Check buildNumber on production releases
    override var taskAction = {
        ...
        this.status = ChecklistTaskStatus.enumerateTaskStatus(
                versionName.matches("[0-9]+\\.[0-9]+\\.[0-9]+\\.[0-9]+".toRegex()))
